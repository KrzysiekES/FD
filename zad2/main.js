...
class Club {
    contructor(name, city, stadium, capacity, coach, chairman, league) {
        this.name = name;
        this.city = city;
...
let addClub = (name, city, stadium, capacity, coach, chairman, league) => {
    var club = new Club(this.name, this.city, this.stadium, this.capacity, this.coach, this.chairman, this.league);
    clubs.push(club);
}
